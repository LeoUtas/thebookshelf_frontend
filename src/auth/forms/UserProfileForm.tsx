    ...
    return (
        <>
            ...
            <Form {...form}>
                ...
                >
                    <div>
                        <div className="font-garamond text-[1.5rem] font-normal text-white ml-[5.5vw] mr-[14.5vw] mt-[5vh] flex justify-between">
                            <h2>Profile</h2>
                            <h2 className="text-red-600">Danger</h2>
                        </div>

                        <div className="font-garamond text-[1.5rem] font-normal text-white ml-[5.5vw] mr-[16vw] mt-[1vh] flex justify-between">
                            ...
                            <Switch
                                id="dangerOn"
                                onCheckedChange={() => {
                                    setIsDangerSwitchOff(!isDangerSwitchOff);
                                }}
                            />
                        </div>

                        {!isDangerSwitchOff ? (
                            <div className="ml-[72.5vw] mt-[0.5rem]">
                                <Button
                            ...
                            <div className="ml-[72.5vw] mt-[0.5rem] bg-transparent">
                                <Button
