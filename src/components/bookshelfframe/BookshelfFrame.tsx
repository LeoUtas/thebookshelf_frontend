...
export const BookshelfFrame = () => {
    ...
    return (
        <>
            <div className="relative no-scrollbar overflow-y-auto w-[85vw] h-[68vh] rounded-[1.56rem] border-solid border-[0.2rem] border-blue-500 mx-auto mt-[1.25rem] mb-[15vh]">
                ...
                <div>
                    <div className="absolute bottom-2 right-[10vw] sm:right-[9vw] md:right-[5rem] lg:right-[10vw]">
                        <button
                            type="button"
